...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "JohnathanBenge"
    user-mail-address "johnathanbenge@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/johnathanbenge/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/johnathanbenge/bin" "/profile/bin" "/Users/johnathanbenge/.npm-packages/bin" "/Users/johnathanbenge/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
